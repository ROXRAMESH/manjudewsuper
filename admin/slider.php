<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="       navigation" data-simplebar="">
                ...
                <li class="nav-item"><a class="nav-link" href="addNewUpdate.php">
                                <svg class="nav-icon">
                                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-drop"></use>
                                </svg> addNewUpdate</a></li>
                <li class="nav-item"><a class="nav-link" href="addfeedback.php">
                                <svg class="nav-icon">
                                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-puzzle"></use>
                                </svg> addfeedback</a></li>

                <li class="nav-item"><a class="nav-link" href="viewInquire.php">
                                <svg class="nav-icon">
                                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
                                </svg> viewInquire</a></li>
                <li class="nav-item"><a class="nav-link" href="viewUpdates.php">
                                <svg class="nav-icon">
                                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
                                </svg> viewUpdates</a></li>
                <li class="nav-item"><a class="nav-link" href="viewFeedback.php">
                                <svg class="nav-icon">
                                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
                                </svg> viewFeedback</a></li>
